...
int main(int argc, char *argv[])
{
    ...
    icmphead->icmp_cksum = checksum(48, (unsigned short *)icmphead);
    
    /* Finally, send the packet */
    fprintf(stdout, "Sending request...\n");
    if (sendto(icmp_sock, dgram, 68, 0, (struct sockaddr *)&addr,
    ...
    if (recvfrom(icmp_sock, recvbuff, 68, 0, (struct sockaddr *)&src,
		 &src_addr_size) < 0) {
